...
ミニかわロボは、組立てから操縦、そして対戦までを体験できるワークショップを不定期に開催しています。

ロボット製作とバトルの楽しさを気軽に体験できる機会を提供しています。
...
### キッズ向けロボットづくりワークショップ in 今治 (2026年8月22日-23日)

2026年8月22日（土）・23日（日）に、SUNABACO今治にて子どもたちを対象とした2日間のワークショップを開催しました。

1日目は基板へのはんだ付けからスタートし、2日目にロボット本体とコントローラーの組み立て、プログラム書き込み、動作確認までを行いました。
...
| **開催場所** | SUNABACO今治 |
| **対象** | 小学生程度〜 |
| **内容** | 基板はんだ付け → 組立 → プログラム書き込み → 動作確認 |

イベントレポート: [失敗して、直して、動いた！子どもたちのロボットづくり2日間｜SUNABACOイベントレポート](https://note.com/sunabaco_event/n/n3da44882a851)

このワークショップの参加者を対象に、**2026年11月3日（火）**に今治地域地場産業振興センターにて「ミニかわロボ大会」を開催予定です。
